      ...
      <div className="container mx-auto px-4 md:px-6 pt-16 pb-8">
        ...
        <div className="border-t border-border/50 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2009-{currentYear} nHRMS Inc. All rights reserved. | <a href="https://rytadvisory.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">An RYT Group Firm</a>
          </p>
